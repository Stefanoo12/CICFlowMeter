...
public class BasicFlow {
    ...
    private String getOrDefault(boolean match, Object value) {
        if (match) {
    ...
    public String toCvsLine(List<FlowFeature> features) {

        Map<FlowFeature, Supplier<String>> generatorByFeature = initGeneratorMap();
    ...
    public String dumpFlowBasedFeaturesEx() {
        ...
        String starttime = DateFormatter.convertMilliseconds2String(flowStartTime / 1000L, "dd/MM/yyyy hh:mm:ss.SSS a");
